...
//            }
//            m_IsLoadAudio = true;
//            WebDownloadTool.WebDownLoadAudioClipMP3(MusicPlayerData.MusicFilePath + @"\" + musicFileName + ".mp3", (clip) =>
//             {
//                 m_Ac = clip;//音频
//                 Debuger.Log("加载歌曲音频成功");
//                 GetAlbumCover(MusicPlayerData.MusicFilePath + @"\" + musicFileName + ".mp3", (cover) =>
//                 {
//                     Debug.Log("歌曲封面加载成功");
//                     m_Cover = cover;
//                 });//封面       
